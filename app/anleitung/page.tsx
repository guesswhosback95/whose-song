        ...
        <div className="ws-stack">
          <div className="ws-card">
            ...
            <ol style={{ marginTop: 12, paddingLeft: 18, display: "grid", gap: 10 }}>
              ...
              <li>
                ...
                <div className="ws-muted">Richtig geraten: +10 · Owner bekommt +5 pro richtigem Vote von anderen.</div>
              </li>
              <li>
                <span className="ws-name">🔥 Banger (1x pro Runde pro Spieler)</span>
                <div className="ws-muted">
                  Während des Ratens kann jeder genau 1x pro Runde einen Banger vergeben (nicht an sich selbst). Am
                  Rundenende gibt’s +5 Bonus nur bei eindeutigem Sieger (kein Bonus bei Gleichstand).
                </div>
              </li>
              <li>
            ...
            <div className="ws-muted" style={{ marginTop: 12 }}>
              Tipp: Zieht eure Genre/Theme-Karte <b>vor Ort</b> – die Karte ist nur ein Hinweis/Flavor und nicht Teil der
              App.
            </div>
          </div>
          ...
          <div className="ws-card">
            ...
            <div className="ws-muted" style={{ marginTop: 12 }}>
              ...
              <span className="ws-chip" style={{ marginLeft: 8 }}>
                {" "}
                /anleitung{" "}
              </span>
            </div>
